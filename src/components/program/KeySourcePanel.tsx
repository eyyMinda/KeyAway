  ...
  return (
    <div className="mx-auto max-w-360 border-t border-[#2a475e]/50 px-4 py-3 sm:px-6 lg:px-8">
      <p className="text-xs leading-relaxed text-[#8f98a0]">
        Keys listed here come from <span className="text-[#c6d4df]">multiple legitimate sources</span> — official vendor
        promos, partner or affiliate giveaways, and community-checked submissions. Each key may come from a different
        channel.
      </p>
