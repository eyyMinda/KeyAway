    ...
    <>
      ...
      <div className="flex justify-center space-x-2">
        ...
        <button
          ...
          className="w-full inline-flex justify-center items-center px-3 py-1 text-white text-xs font-semibold rounded-lg transition-colors duration-200 group relative bg-primary-600 hover:bg-primary-700 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={isDisabled}
