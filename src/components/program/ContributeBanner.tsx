...
function ContributeSection({
  ...
  return (
    <div className={`text-center lg:text-left ${className}`}>
      ...
      <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl lg:text-2xl xl:text-3xl">{title}</h3>
      <p className="mb-4 text-sm leading-relaxed text-neutral-100 sm:mb-5 sm:text-base lg:mb-6 lg:text-lg">
        {description}
      </p>
      {content}
    </div>
...
export default function ContributeBanner() {
  return (
    <section className="border-t border-[#2a475e] static-bg py-6 sm:py-10 lg:py-12">
        ...
        <div className="rounded-sm border border-[#2a475e] bg-[#1b2838] p-5 sm:p-6 lg:p-8 xl:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 items-center">
            <ContributeSection
              ...
              icon={<FaKey className="h-6 w-6 text-white sm:h-7 sm:w-7 lg:h-8 lg:w-8" />}
            ...
            <ContributeSection
              ...
              icon={<FaExclamationCircle className="h-6 w-6 text-white sm:h-7 sm:w-7 lg:h-8 lg:w-8" />}
              ...
              content={
                <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 text-xs sm:text-sm">
                  <div className="flex items-center rounded-sm border border-[#3d6e1c] bg-[#1a3a2a] px-3 py-1.5 sm:px-4 sm:py-2">
                    ...
                    <span className="whitespace-nowrap font-medium text-neutral-50">Report Working</span>
                  </div>
                  <div className="flex items-center rounded-sm border border-[#6d2626] bg-[#2a2020] px-3 py-1.5 sm:px-4 sm:py-2">
                    ...
                    <span className="whitespace-nowrap font-medium text-neutral-50">Report Expired</span>
                  </div>
                  <div className="flex items-center rounded-sm border border-[#a3421b] bg-[#3a2800] px-3 py-1.5 sm:px-4 sm:py-2">
                    ...
                    <span className="whitespace-nowrap font-medium text-neutral-50">Report Limit</span>
                  </div>
                </div>
              }
            />
