...
export default function FeaturedProgramSection({ program }: FeaturedProgramSectionProps) {
  ...
  return (
    <section
      id="featured-program"
      className="py-8 sm:py-12 lg:py-16 bg-linear-to-b from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-360 mx-auto px-4 sm:px-6">
        {/* Header */}
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center space-x-2 bg-purple-800 text-white px-4 py-2 rounded-full text-sm font-semibold mb-3">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 relative">
            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-4 sm:space-y-5">
                ...
                {/* Key Statistics */}
                <div className="bg-linear-to-br from-primary-500/10 to-blue-500/10 rounded-lg p-4 border border-primary-500/20">
                  <ul className="space-y-2 text-sm sm:text-base text-gray-300">
                    <li className="flex items-start space-x-2">
                      <FaCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 mt-0.5 shrink-0" />
                      <span>
