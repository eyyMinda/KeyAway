...
export default function ContributeSection() {
  return (
    <section className="border-t border-[#2a475e] static-bg py-8 sm:py-10">
      <div className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12">
          ...
          <div className="card-base rounded-sm p-6 text-center sm:p-8">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-sm border border-[#4a90c4] bg-[#1a3a5c] sm:mb-6 sm:h-16 sm:w-16">
              <FaKey className="h-6 w-6 text-white sm:h-7 sm:w-7" />
            </div>
            <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl">Share CD Keys</h3>
          ...
          <div className="card-base rounded-sm p-6 text-center sm:p-8">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-sm border border-[#3d6e1c] bg-[#1a3a2a] sm:mb-6 sm:h-16 sm:w-16">
              <FaCheckCircle className="h-6 w-6 text-white sm:h-7 sm:w-7" />
            </div>
            <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl">Report Key Status</h3>
            <p className="text-sm leading-relaxed text-neutral-100 sm:text-base">
          ...
          <div className="card-base rounded-sm p-6 text-center sm:col-span-2 sm:p-8 lg:col-span-1">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-sm border border-[#5a4592] bg-[#2a2040] sm:mb-6 sm:h-16 sm:w-16">
              <FaHeart className="h-6 w-6 text-white sm:h-7 sm:w-7" />
            </div>
            <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl">Spread the Word</h3>
            <p className="text-sm leading-relaxed text-neutral-100 sm:text-base">
        ...
        <div className="text-center">
          <ContactModalTrigger
            tab="suggest"
            className="inline-flex cursor-pointer items-center rounded-sm border border-[#5c8529] bg-[#4c6b22] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#5c8529] hover:text-white sm:px-8 sm:py-4 sm:text-base">
